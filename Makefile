...
# rules. Do not modify anthing outside of that section.
#
...
EC: $(OBJS)
	@echo "Making extra credit executable..."
	$(GCC) -o 'mylsEC' -g -Wall -std=c99 pa4.h pa4EC.h mainEC.c $(EC_SRC)
	@echo ""
	@echo "Done. Generated executable: mylsEC"
